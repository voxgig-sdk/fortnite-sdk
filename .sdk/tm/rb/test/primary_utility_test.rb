...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = FortniteOmni.make_runner(TEST_JSON_FILE, FortniteSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : FortniteOmni.errify(err)
    end
