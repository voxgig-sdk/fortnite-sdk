...
// Fortnite SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FortniteOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FortniteOmni::structfix($now, Struct::undef()))
                        !== json_encode(FortniteOmni::structfix($val, Struct::undef()))) {
