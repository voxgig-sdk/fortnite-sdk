...
// Fortnite SDK streaming feature
...
class FortniteStreamingFeature extends FortniteBaseFeature
{
    ...
    private function _iterate(FortniteResult $result): \Generator
    {
    ...
    private function _streamable(FortniteContext $ctx): bool
    {
