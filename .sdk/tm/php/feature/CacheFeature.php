...
class FortniteCacheFeature extends FortniteBaseFeature
{
    ...
    private function _through(FortniteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
