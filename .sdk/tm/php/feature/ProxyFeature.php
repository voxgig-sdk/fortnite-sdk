...
class FortniteProxyFeature extends FortniteBaseFeature
{
    ...
    public function init(FortniteContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FortniteContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
