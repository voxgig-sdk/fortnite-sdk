...
class FortniteRbacFeature extends FortniteBaseFeature
{
    ...
    private function _required(FortniteContext $ctx): ?string
    {
    ...
    private function _reject(FortniteContext $ctx, string $required): void
    {
    ...
    private function _track(FortniteContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
