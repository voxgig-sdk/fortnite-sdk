...
// Fortnite SDK clienttrack feature
...
class FortniteClienttrackFeature extends FortniteBaseFeature
{
    ...
    public function PostConstruct(FortniteContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Fortnite-SDK';
