...
// Fortnite SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FortniteTestFeature extends FortniteBaseFeature
{
    ...
    public function init(FortniteContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FortniteContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FortniteContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FortniteContext $ctx, $op, $args): array
    {
