...
// Fortnite SDK utility: fetcher

class FortniteFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FortniteSDK/1.0)';
    ...
    public static function call(FortniteContext $ctx, string $fullurl, array $fetchdef): array
    {
