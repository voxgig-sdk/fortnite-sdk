...
describe('exists', async () => {
  ...
  //
  // FortniteSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof FortniteSDK, true,
      'FortniteSDK.test() must return a client synchronously')
  })
