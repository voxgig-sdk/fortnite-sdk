...
|---|---|---|
| `ts/` | @voxgig-sdk/fortnite-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fortnite-sdk \
      --repository voxgig-sdk/fortnite-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fortnite-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fortnite-sdk --id=<id>` removes it.
