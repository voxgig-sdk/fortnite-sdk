...
The PHP SDK for the Fortnite API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Cosmetic(null)->list(null, null);
...
[$result, $err] = $client->Fortnite(null)->load(
    ["id" => "test01"], null
);
