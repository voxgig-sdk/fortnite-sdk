...
class FortniteGraphql
{
    ...
    // equivalent.
    public static function body(FortniteContext $ctx): mixed
    {
    ...
    public static function errors(FortniteContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
