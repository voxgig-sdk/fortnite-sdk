...
// Fortnite SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FortniteMakeRequest
{
    public static function call(FortniteContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FortniteResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FortniteResponse($fetched);
        } else {
