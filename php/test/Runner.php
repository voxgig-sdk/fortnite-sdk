...
class FortniteTestRunner
{
    ...
    {
        $live = self::getenv('FORTNITE_TEST_LIVE');
        $override = self::getenv('FORTNITE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FORTNITE_TEST_EXPLAIN');
...
class_alias('FortniteTestRunner', 'Runner');
class_alias('FortniteHelpers', 'Helpers');
