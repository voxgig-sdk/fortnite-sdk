...
// Fortnite SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FortniteSDK::test)
...
{
    private const SDK_CLASS = 'FortniteSDK';
    ...
    private const SDK_BASE = 'fortnite_sdk';
