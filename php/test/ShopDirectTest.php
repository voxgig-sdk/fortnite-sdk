...
class ShopDirectTest extends TestCase
{
    public function test_direct_load_shop(): void
    {
        $setup = shop_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-shop", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
