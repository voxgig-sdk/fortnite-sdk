...
// Fortnite SDK ratelimit feature
...
class FortniteRatelimitFeature extends FortniteBaseFeature
{
    ...
    private function _acquire(FortniteContext $ctx): void
    {
    ...
    private function _track(FortniteContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
