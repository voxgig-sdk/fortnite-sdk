...
class FortniteTimeoutFeature extends FortniteBaseFeature
{
    ...
    private function _with_timeout(FortniteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FortniteContext $_ctx, float $ms): void
    {
        $client = $this->client;
