...
describe('ShopEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let shop_ref01_data = Object.values(setup.data.existing.shop)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/shop/ShopTestData.json')
