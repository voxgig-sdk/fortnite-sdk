...
(0, node_test_1.describe)('ShopDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-shop', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-shop', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FORTNITE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FortniteSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FORTNITE_TEST_SHOP_ENTID'];
    ...
    const client = new __1.FortniteSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ShopDirect.test.js.map