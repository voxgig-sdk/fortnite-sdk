...
function envOverride(m) {
    if ('TRUE' === process.env.FORTNITE_TEST_LIVE ||
        'TRUE' === process.env.FORTNITE_TEST_OVERRIDE) {
    ...
    m.FORTNITE_TEST_EXPLAIN = process.env.FORTNITE_TEST_EXPLAIN || m.FORTNITE_TEST_EXPLAIN;
    return m;
}
