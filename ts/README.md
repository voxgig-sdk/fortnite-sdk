# Fortnite TypeScript SDK

The TypeScript SDK for the Fortnite API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `FortniteSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `FortniteSDK.test(testopts?, sdkopts?)` | `FortniteSDK` | Create a test-mode client. |
