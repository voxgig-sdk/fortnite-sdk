# Fortnite TypeScript SDK Reference

Complete API reference for the Fortnite TypeScript SDK.
...
```ts
new FortniteSDK(options?: object)
```
...
#### `FortniteSDK.test(testopts?, sdkopts?)`
...
**Returns:** `FortniteSDK` instance in test mode.
...
Create a new `Shop` entity instance.
...
Return the parent `FortniteSDK` instance.
