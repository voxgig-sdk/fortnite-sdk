...
describe("ShopDirect", function()
  it("should direct-load-shop", function()
    local setup = shop_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-shop", setup.live and "live" or "unit")
...
function shop_direct_setup(mockres)
