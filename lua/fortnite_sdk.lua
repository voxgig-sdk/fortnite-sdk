...
local FortniteSDK = {}
FortniteSDK.__index = FortniteSDK
...
FortniteSDK._make_feature = _make_feature


function FortniteSDK.new(options)
  local self = setmetatable({}, FortniteSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function FortniteSDK:options_map()
...
function FortniteSDK:get_utility()
  return Utility.copy(self._utility)
end


function FortniteSDK:get_root_ctx()
  return self._rootctx
end


function FortniteSDK:prepare(fetchargs)
...
function FortniteSDK:direct(fetchargs)
...
-- by passing it.
function FortniteSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function FortniteSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "FortniteSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function FortniteSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = FortniteSDK.new(sdkopts)
  sdk.mode = "test"
