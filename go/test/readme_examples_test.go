...
const testSeed = `map[string]any{"entity": map[string]any{"cosmetic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "shop": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "statistic": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
