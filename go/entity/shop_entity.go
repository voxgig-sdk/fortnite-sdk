...
func NewShopEntity(client *core.FortniteSDK, entopts map[string]any) *ShopEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShopEntity) GetName() string { return e.name }
...
func (e *ShopEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShopEntity) Deleted() bool {
	return e.deleted
}


func (e *ShopEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShopEntity(e.client, opts)
}

func (e *ShopEntity) Data(args ...any) any {
...
func (e *ShopEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Shop; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShopEntity) DataTyped(data ...Shop) Shop {
	if len(data) > 0 {
		return typedFrom[Shop](e.Data(asMap(data[0])))
	}
	return typedFrom[Shop](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Shop (all fields
// optional at the wire level).
func (e *ShopEntity) MatchTyped(match ...Shop) Shop {
	if len(match) > 0 {
		return typedFrom[Shop](e.Match(asMap(match[0])))
	}
	return typedFrom[Shop](e.Match())
}
...
func (e *ShopEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShopEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShopLoadMatch and returns an Shop. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ShopEntity) LoadTyped(reqmatch ShopLoadMatch, ctrl map[string]any) (Shop, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Shop{}, err
	}
	return typedFrom[Shop](res), nil
}



func (e *ShopEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ShopEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ShopEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShopEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShopEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
