...
func (sdk *FortniteSDK) OptionsMap() map[string]any {
...
func (sdk *FortniteSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FortniteSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FortniteSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FortniteSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FortniteSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FortniteSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FortniteSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FortniteSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FortniteSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FortniteSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
