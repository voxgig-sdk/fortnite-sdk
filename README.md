...
The Fortnite API provides a wealth of data related to the popular battle royale game, including player statistics, cosmetics, daily shop items, news updates, and various game modes.

Learn more about Fortnite API at [fortnite-api.com](https://fortnite-api.com).
...
$cosmetics = $client->Cosmetic()->list();
print_r(array_map(fn($item) => $item->data_get(), $cosmetics));
```
