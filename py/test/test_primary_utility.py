...
from fortnite_sdk.utility.voxgig_struct import voxgig_struct as vs
from fortnite_sdk import FortniteSDK
from fortnite_sdk.core.spec import FortniteSpec
from fortnite_sdk.core.result import FortniteResult
from fortnite_sdk.core.response import FortniteResponse
from fortnite_sdk.core.operation import FortniteOperation
from fortnite_sdk.core.error import FortniteError
from fortnite_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FortniteSDK.test(None, None)
        ...
        class TestInitFeature(FortniteBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FortniteBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FortniteSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FortniteSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FortniteSDK.test(None, setup_opts)
