# Fortnite SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FortniteSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FortniteSDK(...) and FortniteSDK.test(...) become
#      FortniteSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fortnite_sdk"
_SDK_CLASS = "FortniteSDK"
