...
from fortnite_sdk.core.control import FortniteControl
...
from fortnite_sdk.core.helpers import get_ctx_prop, to_map
...
class FortniteContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, FortniteResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FortniteResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FortniteError(code, msg, self)
