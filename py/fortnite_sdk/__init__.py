...
from fortnite_sdk.utility import register

# Load features
from fortnite_sdk.feature.base_feature import FortniteBaseFeature
from fortnite_sdk.features import _has_feature, _make_feature
...
class FortniteSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FortniteUtility()
        self._utility = utility

        from fortnite_sdk.config import shared_config
    ...
    def get_utility(self):
        return FortniteUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FortniteSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Cosmetic(self, data=None) -> "CosmeticEntity":
        ...
        from fortnite_sdk.entity.cosmetic_entity import CosmeticEntity
        return CosmeticEntity(self, data)


    def Shop(self, data=None) -> "ShopEntity":
        """Entity factory: client.Shop().list() / client.Shop().load({"id": ...})."""
        from fortnite_sdk.entity.shop_entity import ShopEntity
    ...
    def Statistic(self, data=None) -> "StatisticEntity":
        ...
        from fortnite_sdk.entity.statistic_entity import StatisticEntity
