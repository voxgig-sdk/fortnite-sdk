...
module FortniteTestRunner
  ...
  def self.env_override(m)
    live = getenv("FORTNITE_TEST_LIVE")
    override = getenv("FORTNITE_TEST_OVERRIDE")
    ...
    explain = getenv("FORTNITE_TEST_EXPLAIN")
    m["FORTNITE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = FortniteTestRunner
Helpers = FortniteHelpers
Vs = VoxgigStruct
