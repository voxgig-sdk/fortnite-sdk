...
func registerSDKWords(r *eng.Registry, client *sdk.FortniteSDK) {
...
func runOp(client *sdk.FortniteSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
