...
type Args struct {
	Entity string         `json:"entity" jsonschema:"cosmetic | shop | statistic"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FortniteSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fortnite_list",
		Description: "List records from Fortnite. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fortnite_load",
		Description: "Load a single record from Fortnite. " +
...
func runOp(client *sdk.FortniteSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FortniteSDK, name string) (sdk.FortniteEntity, error) {
	switch strings.ToLower(name) {
	case "cosmetic":
		return client.Cosmetic(nil), nil
	case "shop":
		return client.Shop(nil), nil
	case "statistic":
